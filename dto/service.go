...
type ServiceListInput struct {
	...
	PageSize int    `json:"page_size" form:"page_size" comment:"每页条数" example:"10" validate:"required"` //每页条数
}

// ServiceListOutput 服务列表出参
...
//ServiceAddHTTPInput 添加http接口输入
